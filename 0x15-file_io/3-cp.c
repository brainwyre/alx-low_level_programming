 ...
 * @file: The file buffer name is holding chars for.
 *
...
/**
 * close_file - The file descriptor that will be closed.
 ...
 * Return: 0 on success.
 *
 * Description: If the number of arguments is wrong - exit code 97.
